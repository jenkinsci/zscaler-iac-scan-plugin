...
public class SCMDetailsTest {
  ...
  public void populateSCMDetails() throws IOException {
    ...
    Path configXmlFile = Paths.get(builds.getPath(), "git_freestyle.xml");
    ...
    configXmlFile = Paths.get(builds.getPath(), "git_pipeline.xml");
    ...
    configXmlFile = Paths.get(builds.getPath(), "svn_freestyle.xml");
    configxml = IOUtils.toString(configXmlFile.toUri(), Charset.defaultCharset());
    ...
    configXmlFile = Paths.get(builds.getPath(), "svn_pipeline.xml");
    configxml = IOUtils.toString(configXmlFile.toUri(), Charset.defaultCharset());
